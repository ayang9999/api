...
class userControllerMod
{
    #[api(name:"获取用户信息第二版", path: "/get", method: "get", desc: "返回参考保存用户信息字段", category: "用户信息")]
...
//            'album' => ["www.img.com"],
    ...
    #[api(name:"保存用户手机号", path: "/phone", method: "post", desc: "保存用户手机号", category: "用户信息")]
    #[param("code", "string", "code", )]
    #[request(['code' => "f65ca51a3fe79fcccdbde3593ea8d5f09e66f1ad418b02a13b728656b5bf7839"])]
...
//    }
    ...
    #[api(name:"注销用户", path: "/newLogout", method: "delete", desc: "", category: "用户信息")]
